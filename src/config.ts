...
export const siteConfig: SiteConfig = {
	title: "Mkrari Blog",
	subtitle: "Astro 博客模板",
	siteURL: "https://example.com/", // 替换为你的站点 URL，并保留末尾斜杠
	siteStartDate: "2026-01-01", // 站点开始运行日期
	...
	navbarTitle: {
		...
		icon: "assets/home/logo1.webp",
		// 网站Logo图片路径
		logo: "assets/home/logo1.webp",
	},
...
export const commentConfig: CommentConfig = {
	enable: false, // 默认关闭；配置 Twikoo 后再启用。
	twikoo: {
		envId: "",
		lang: SITE_LANG,
	},
